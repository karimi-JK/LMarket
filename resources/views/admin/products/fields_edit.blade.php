...
<div class="form-group col-sm-6">
	...
	-->
	<select name="publisher_id" class="form-control" id="publisher_id_select">
...
<div class="form-group col-sm-6">
	...
	-->	
	<div class="col-sm-6">
		<img src="{!!url('/images/products')!!}/{!!$product->image!!}" width=80% >
	</div>
	<div class="col-sm-6">
		{!! Form::label('Change Image') !!}
		{!! Form::file('image_replace', null , ['class' => 'form-control']) !!}	
	</div>
