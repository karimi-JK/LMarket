...
<div class="form-group col-sm-6 hidden">
    ...
    {!! Form::hidden('product_id', $id, ['class' => 'form-control' ]) !!}
</div>
...
<div class="form-group col-sm-6">
	<!--
    {!! Form::label('apk', 'Apk:') !!}
    {!! Form::text('apk', null, ['class' => 'form-control']) !!}
	-->
	
	{!! Form::label('Apk') !!}
    {!! Form::file('apk', null , ['class' => 'form-control']) !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.versions.index',$id) !!}" class="btn btn-default">Cancel</a>
</div>
